      ...
      <section className='rounded-xl border border-gray-200 bg-white p-6 space-y-4'>
        ...
        {isPublic && shareUrl ? (
          <div className='space-y-3'>
            <div className='flex gap-2'>
              ...
              <button
                type='button'
                onClick={handleCopy}
                className='rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors'
              >
                {copied ? 'Copied!' : 'Copy'}
              </button>
            </div>
          ...
          <button
            ...
            onClick={handleShare}
            disabled={loading}
            className='w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
          >
